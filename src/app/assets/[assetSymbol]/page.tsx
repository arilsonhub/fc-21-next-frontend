...
export default async function AssetDashboard({params, searchParams} : {params: Promise<{assetSymbol: string}>; searchParams: Promise<{walletId: string}>;}) {
        ...
        <div className="flex flex-col space-y-5 flex-grow">
            ...
            <div className="grid grid-cols-5 flex-grow gap-2">
                <div className="col-span-2">
                    <Card>
                        <Tabs>
                            <TabsItem active title={<div className="text-blue-700">Compra</div>}>
